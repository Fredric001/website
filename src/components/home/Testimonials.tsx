    ...
    <section className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8 font-['Poppins',sans-serif]">
      ...
      <div className="mt-16 pt-8 border-t border-gray-200">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div>
            <div className="text-3xl md:text-4xl font-bold text-[#003b5c]">4.9/5</div>
            <div className="text-gray-600 mt-2">Average Rating</div>
          </div>
          <div>
            <div className="text-3xl md:text-4xl font-bold text-[#003b5c]">1500+</div>
            <div className="text-gray-600 mt-2">Students Enrolled</div>
          </div>
          <div>
            <div className="text-3xl md:text-4xl font-bold text-[#003b5c]">98%</div>
            <div className="text-gray-600 mt-2">Would Recommend</div>
          </div>
        </div>
      </div>
    </section>
