  ...
  return (
    <section className="bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto px-4">
        ...
        {/* Header */}
        <div className="text-center mb-4  gap-8">
          <div className="text-center mb-4  gap-8">
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Together for Digital Literacy
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              We’re proud to collaborate with progressive companies and schools to build a
              better digital future for the next generation. Together, we’re
              working to empower children with the digital skills they need to
